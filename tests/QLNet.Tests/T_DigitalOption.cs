...
namespace QLNet.Tests
{
    ...
    [JetBrains.Annotations.PublicAPI] public class T_DigitalOption
    {
        ...
        public void testCashAtHitOrNothingAmericanValues()
        {
            ...
            new DigitalOptionData(QLNet.Option.Type.Call, 100.00, 105.00, 0.00, 0.10, 0.5, 0.20, 15.0000, 1e-16, true),
            new DigitalOptionData(QLNet.Option.Type.Put,  100.00,  95.00, 0.00, 0.10, 0.5, 0.20, 15.0000, 1e-16, true),
            // non null dividend (cross-tested with MC simulation)
            new DigitalOptionData(QLNet.Option.Type.Put,  100.00, 105.00, 0.20, 0.10, 0.5, 0.20, 12.2715, 1e-4,  true),
            new DigitalOptionData(QLNet.Option.Type.Call, 100.00,  95.00, 0.20, 0.10, 0.5, 0.20,  8.9109, 1e-4,  true),
            new DigitalOptionData(QLNet.Option.Type.Call, 100.00, 105.00, 0.20, 0.10, 0.5, 0.20, 15.0000, 1e-16, true),
            new DigitalOptionData(QLNet.Option.Type.Put,  100.00,  95.00, 0.20, 0.10, 0.5, 0.20, 15.0000, 1e-16, true)
         };
        ...
        public void testAssetAtHitOrNothingAmericanValues()
        {
            ...
            new DigitalOptionData(QLNet.Option.Type.Put,  100.00, 105.00, 0.01, 0.10, 0.5, 0.20, 65.7811, 1e-04, true),
            new DigitalOptionData(QLNet.Option.Type.Call, 100.00,  95.00, 0.01, 0.10, 0.5, 0.20, 76.8858, 1e-04, true),
            // in the money options  (guaranteed immediate payoff = spot)
            new DigitalOptionData(QLNet.Option.Type.Call, 100.00, 105.00, 0.00, 0.10, 0.5, 0.20, 105.0000, 1e-16, true),
            new DigitalOptionData(QLNet.Option.Type.Put,  100.00,  95.00, 0.00, 0.10, 0.5, 0.20, 95.0000, 1e-16, true),
            new DigitalOptionData(QLNet.Option.Type.Call, 100.00, 105.00, 0.01, 0.10, 0.5, 0.20, 105.0000, 1e-16, true),
            new DigitalOptionData(QLNet.Option.Type.Put,  100.00,  95.00, 0.01, 0.10, 0.5, 0.20, 95.0000, 1e-16, true)
         };
        ...
        public void testCashAtExpiryOrNothingAmericanValues()
        {
            ...
            new DigitalOptionData(QLNet.Option.Type.Put,  100.00, 105.00, 0.00, 0.10, 0.5, 0.20,  4.9081, 1e-4, false),
            new DigitalOptionData(QLNet.Option.Type.Call, 100.00,  95.00, 0.00, 0.10, 0.5, 0.20,  3.0461, 1e-4, false),
            // in the money options (guaranteed discounted payoff)
            new DigitalOptionData(QLNet.Option.Type.Call, 100.00, 105.00, 0.00, 0.10, 0.5, 0.20, 15.0000 * System.Math.Exp(-0.05), 1e-12, true),
            new DigitalOptionData(QLNet.Option.Type.Put,  100.00,  95.00, 0.00, 0.10, 0.5, 0.20, 15.0000 * System.Math.Exp(-0.05), 1e-12, true),
            // out of bonds case
            new DigitalOptionData(QLNet.Option.Type.Call,   2.37,   2.33, 0.07, 0.43, 0.19, 0.005,  0.0000, 1e-4, false),
         };
        ...
        public void testAssetAtExpiryOrNothingAmericanValues()
        {
            ...
            new DigitalOptionData(QLNet.Option.Type.Put,  100.00, 105.00, 0.00, 0.10, 0.5, 0.20, 40.1574, 1e-04, false),
            new DigitalOptionData(QLNet.Option.Type.Call, 100.00,  95.00, 0.00, 0.10, 0.5, 0.20, 17.2983, 1e-04, false),
            // data from Haug VBA code results
            new DigitalOptionData(QLNet.Option.Type.Put,  100.00, 105.00, 0.01, 0.10, 0.5, 0.20, 65.5291, 1e-04, true),
            new DigitalOptionData(QLNet.Option.Type.Call, 100.00,  95.00, 0.01, 0.10, 0.5, 0.20, 76.5951, 1e-04, true),
            // in the money options (guaranteed discounted payoff = forward * riskFreeDiscount
            //                                                    = spot * dividendDiscount)
            new DigitalOptionData(QLNet.Option.Type.Call, 100.00, 105.00, 0.00, 0.10, 0.5, 0.20, 105.0000, 1e-12, true),
            new DigitalOptionData(QLNet.Option.Type.Put,  100.00,  95.00, 0.00, 0.10, 0.5, 0.20, 95.0000, 1e-12, true),
            new DigitalOptionData(QLNet.Option.Type.Call, 100.00, 105.00, 0.01, 0.10, 0.5, 0.20, 105.0000 * System.Math.Exp(-0.005), 1e-12, true),
            new DigitalOptionData(QLNet.Option.Type.Put,  100.00,  95.00, 0.01, 0.10, 0.5, 0.20, 95.0000 * System.Math.Exp(-0.005), 1e-12, true)
         };
        ...
        //      int requiredSamples = (int)(System.Math.Pow(2.0, 14)-1);
