    ...
    public class T_Interpolations
    {
        ...
        */
        ...
        public void testSplineOnGenericValues()
        {
            ...
            for (i = 0; i < n; i++)
            {
                ...
                if (System.Math.Abs(error) > 3e-16)
                {
                    QAssert.Fail("Natural spline interpolation "
        ...
        */
        ...
        public void testNonRestrictiveHymanFilter()
        {
            ...
            if (System.Math.Abs(interpolated - expected) > 1e-15)
            {
                QAssert.Fail("MC not-a-knot spline"
                             ...
                             + "\n    error:              "
                             + System.Math.Abs(interpolated - expected));
            }
        ...
        //                        double error = System.Math.Abs(interpolated-expected);
                        ...
                        for (int k_b = 0; k_b < isBetaFixed.Length; ++k_b)
                        {
                            for (int k_n = 0; k_n < isNuFixed.Length; ++k_n)
                            {
                                for (int k_r = 0; k_r < isRhoFixed.Length; ++k_r)
                                {
                                    ...
                                    error = System.Math.Abs(initialAlpha - calibratedAlpha);
                                    ...
                                    // Beta
                                    error = System.Math.Abs(initialBeta - calibratedBeta);
                                    if (error > calibrationTolerance)
                                    {
                                    ...
                                    // Nu
                                    error = System.Math.Abs(initialNu - calibratedNu);
                                    if (error > calibrationTolerance)
                                    {
                                    ...
                                    // Rho
                                    error = System.Math.Abs(initialRho - calibratedRho);
                                    if (error > calibrationTolerance)
                                    {
            ...
            for (int i = 0; i < lambdaVec.Count; ++i)
            {
                ...
                for (int j = 0; j < yd.Count; ++j)
                {
                    ...
                    for (int dIt = 0; dIt < deltaGrid.Count; ++dIt)
                    {
                        ...
                        if (System.Math.Abs(expectedVal - calcVal) > tolerance)
                        {
                            ...
                            QAssert.Fail("Kernel interpolation failed at x = "
                                         ...
                                         + "\n    error:              "
                                         + System.Math.Abs(expectedVal - calcVal));
        ...
        public void testBicubicDerivatives()
        {
            ...
            for (int i = 5; i < 95; i += 10)
            {
                for (int j = 5; j < 95; j += 10)
                {
                    ...
                    if (System.Math.Abs(f_xx + y[i] / 10 * System.Math.Sin(x[j])) > tol)
                    {
                        QAssert.Fail("Failed to reproduce f_xx");
                    }
                    if (System.Math.Abs(f_y - (System.Math.Sin(x[j]) / 10 - System.Math.Sin(y[i]))) > tol)
                    {
                        QAssert.Fail("Failed to reproduce f_y");
                    }
                    if (System.Math.Abs(f_yy + System.Math.Cos(y[i])) > tol)
                    {
                        QAssert.Fail("Failed to reproduce f_yy");
                    }
                    if (System.Math.Abs(f_xy - System.Math.Cos(x[j]) / 10) > tol)
                    {
            ...
            for (int i = 0; i < xBegin.Count; i++)
            {
                ...
                if (System.Math.Abs(interpolated - yBegin[i]) > tolerance)
                {
                    QAssert.Fail(type + " interpolation failed at x = " + xBegin[i]
                                 ...
                                 + "\n    error:              "
                                 + System.Math.Abs(interpolated - yBegin[i]));
                }
            }
        }
