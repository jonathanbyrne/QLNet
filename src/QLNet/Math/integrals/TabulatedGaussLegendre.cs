...
namespace QLNet.Math.integrals
{
    ...
    public class TabulatedGaussLegendre
    {
        ...
        private static double[] x20 =
        {
            0.076526521133497, 0.227785851141645, 0.373706088715420, 0.510867001950827,
        ...
        public TabulatedGaussLegendre(int n = 20)
        {
            order(n);
        }
