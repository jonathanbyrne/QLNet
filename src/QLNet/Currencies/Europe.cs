...
namespace QLNet.Currencies
{
    ...
    /// </summary>
    [JetBrains.Annotations.PublicAPI] public class BYRCurrency : Currency
    {
    ...
    /// </summary>
    [JetBrains.Annotations.PublicAPI] public class CHFCurrency : Currency
    {
    ...
    /// </summary>
    [JetBrains.Annotations.PublicAPI] public class CYPCurrency : Currency
    {
    ...
    /// </summary>
    [JetBrains.Annotations.PublicAPI] public class DKKCurrency : Currency
    {
    ...
    /// It is divided into 100 cents.
    /// </summary>
    [JetBrains.Annotations.PublicAPI] public class EURCurrency : Currency
    {
    ...
    /// </summary>
    [JetBrains.Annotations.PublicAPI] public class LTLCurrency : Currency
    {
    ...
    /// </summary>
    [JetBrains.Annotations.PublicAPI] public class LVLCurrency : Currency
    {
    ...
    /// It is divided in 100 шre.
    [JetBrains.Annotations.PublicAPI] public class NOKCurrency : Currency
    {
    ...
    [JetBrains.Annotations.PublicAPI] public class PLNCurrency : Currency
    {
    ...
    [JetBrains.Annotations.PublicAPI] public class ROLCurrency : Currency
    {
    ...
    */
    ...
    [JetBrains.Annotations.PublicAPI] public class SEKCurrency : Currency
    {
    ...
    [JetBrains.Annotations.PublicAPI] public class SITCurrency : Currency
    {
    ...
    /// Obsoleted by the Euro since 1999.
    [JetBrains.Annotations.PublicAPI] public class PTECurrency : Currency
    {
