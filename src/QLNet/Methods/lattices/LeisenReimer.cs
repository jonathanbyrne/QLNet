...
namespace QLNet.Methods.lattices
{
    ...
    public class LeisenReimer : BinomialTree<LeisenReimer>, ITreeFactory<LeisenReimer>
    {
            ...
            : base(process, end, steps % 2 != 0 ? steps : steps + 1)
        {
            ...
            pu_ = Math.Distributions.Utils.PeizerPrattMethod2Inversion(d2, oddSteps);
            pd_ = 1.0 - pu_;
            var pdash = Math.Distributions.Utils.PeizerPrattMethod2Inversion(d2 + System.Math.Sqrt(variance), oddSteps);
