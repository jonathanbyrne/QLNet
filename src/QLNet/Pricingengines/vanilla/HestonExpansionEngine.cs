...
namespace QLNet.Pricingengines.vanilla
{
    ...
    */
      ...
      OneAssetOption.Results>
    {
        ...
        public override void calculate()
        {
            ...
            double price = Utils.blackFormula(payoff, forward, vol * System.Math.Sqrt(term), riskFreeDiscount, 0);
    ...
    public class LPP2HestonExpansion : HestonExpansion
    {
        ...
        {
            double x = System.Math.Log(strike / forward);
        ...
        {
            return (4 * System.Math.Pow(delta, 2) * kappa * (-theta - 4 * ekt * (theta + kappa * t * (theta - y)) +
        ...
        {
            return delta * rho * (-(delta * System.Math.Pow(-1 + ekt, 2) * rho * (4 * theta - y) * y) +
        ...
        {
            return System.Math.Pow(delta, 2) * System.Math.Sqrt((-theta + kappa * t * theta + (theta - y) / ekt + y) / (kappa * t)) *
    ...
    */
    public class LPP3HestonExpansion : HestonExpansion
    {
        ...
        private double z0(double t, double kappa, double theta, double delta, double y, double rho)
        {
            return (96 * System.Math.Pow(delta, 2) * ekt * System.Math.Pow(kappa, 3) *
        ...
        private double z1(double t, double kappa, double theta, double delta, double y, double rho)
        {
            return delta * (768 * e2kt * System.Math.Pow(kappa, 4) * rho *
                             ((2 + kappa * t + ekt * (-2 + kappa * t)) * theta +
                              (-1 + ekt - kappa * t) * y) -
        ...
        private double z2(double t, double kappa, double theta, double delta, double y, double rho)
        {
            return System.Math.Pow(delta, 2) * (8 * e3kt * System.Math.Pow(kappa, 5) * System.Math.Pow(rho, 2) * System.Math.Pow(t, 4) * (2 + delta * rho * t) *
        ...
        {
            return System.Math.Pow(delta, 3) * ekt * rho * ((-15 * (2 + kappa * t) +
    ...
    */
    public class FordeHestonExpansion : HestonExpansion
    {
        ...
        {
            double v0Sqrt = System.Math.Sqrt(v0);
