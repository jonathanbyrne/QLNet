...
namespace QLNet.Models.Shortrate.Twofactorsmodels
{
    ...
    */
      ...
      ITermStructureConsistentModel
    {
        ...
        {
            return A(t, T) * System.Math.Exp(-B(a(), T - t) * x - B(b(), T - t) * y);
        }
        ...
        {
            return (1.0 - System.Math.Exp(-x * t)) / x;
        }
        #endregion
        ...
        {
            double temp = 1.0 - System.Math.Exp(-(a() + b()) * t);
            double temp1 = 1.0 - System.Math.Exp(-a() * (s - t));
            double temp2 = 1.0 - System.Math.Exp(-b() * (s - t));
            double a3 = a() * a() * a();
            double b3 = b() * b() * b();
        ...
        double V(double t)
        {
            double expat = System.Math.Exp(-a() * t);
            double expbt = System.Math.Exp(-b() * t);
            double cx = sigma() / a();
            double cy = eta() / b();
        ...
        public class FittingParameter : TermStructureFittingParameter
        {
            ...
            private new class Impl : Parameter.Impl
            {
                ...
                public override double value(Vector v, double t)
                {
                    ...
                    double temp1 = sigma_ * (1.0 - System.Math.Exp(-a_ * t)) / a_;
                    double temp2 = eta_ * (1.0 - System.Math.Exp(-b_ * t)) / b_;
        ...
        public class SwaptionPricingFunction
        {
            ...
            public double value(double x)
            {
                ...
                double txy = System.Math.Sqrt(1.0 - rhoxy_ * rhoxy_);
